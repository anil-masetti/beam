;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [687],
  {
    ...
    8416: function (e, n, t) {
      ...
      function o(e) {
        ...
        return (0, s.jsxs)('div', {
          ...
          children: [
            (0, s.jsx)(a.default, {
              href: '/profile/'.concat(n.id),
              children: (0, s.jsxs)('a', {
                className: 'relative inline-flex',
                children: [
                  (0, s.jsx)('span', {
                    className: 'hidden sm:flex',
                    children: (0, s.jsx)(r.q, { name: n.name, src: n.image }),
                  }),
                  (0, s.jsx)('span', {
    ...
    2629: function (e, n, t) {
      ...
      function l(e) {
        var n = e.children
        return (0, s.jsx)('div', { className: 'px-6 pt-6 pb-12', children: n })
      }
      function d(e) {
        var n = e.children
        return (0, s.jsx)('div', {
      ...
      function m(e) {
        var n = e.children,
          t = e.className
        return (0, s.jsx)(a.V.Description, { className: t, children: n })
      }
      function h(e) {
        var n = e.onClick
        return (0, s.jsx)('div', {
          ...
          children: (0, s.jsxs)('button', {
            ...
            children: [
              ...
              (0, s.jsx)(r.b0, { className: 'w-6 h-6', 'aria-hidden': 'true' }),
            ],
          }),
        })
      }
    ...
    9931: function (e, n, t) {
      ...
      function u(e) {
        var n = e.likedBy,
          ...
          x = h[0],
          f = h[1],
          j = (0, c.useSession)().data,
          g = Boolean(
            n.find(function (e) {
              return e.user.id === j.user.id
            })
          ),
          p = n.length
        return (0, s.jsxs)(o.fC, {
          delayDuration: 300,
          children: [
            (0, s.jsx)(o.xz, {
              asChild: !0,
              ...
              children: (0, s.jsxs)(r.z, {
                ...
                className: (0, a.A)(
                  ...
                  x && '!border-red-600 !bg-red-600 dark:!bg-red-600'
                ),
                onClick: function () {
                  x ||
                    (g
                ...
                children: [
                  ...
                  (0, s.jsx)('span', {
                    className: (0, a.A)(
                      ...
                      x && 'transition-colors duration-100 text-gray-50'
                    ),
                    children: p,
                  }),
                ],
                ...
                (0, s.jsxs)('p', {
                  ...
                  children: [
                    n
                      .slice(0, d)
                      .map(function (e) {
                        return e.user.id === j.user.id ? 'You' : e.user.name
                      })
                      .join(', '),
                    p > d && ' and '.concat(p - d, ' more'),
                  ],
                }),
                (0, s.jsx)(o.Eh, {
                  offset: 22,
    ...
    4938: function (e, n, t) {
      ...
      function S(e, n) {
        ...
        for (var t = 0, s = new Array(n); t < n; t++) s[t] = e[t]
        return s
      }
      function A(e, n, t, s, r, i, a) {
        try {
          var o = e[i](a),
            c = o.value
        } catch (l) {
        ...
        o.done ? n(c) : Promise.resolve(c).then(s, r)
      }
      function O(e) {
        return function () {
          var n = this,
      ...
      var L = function () {
        var e = function () {
          ...
          t = function () {
            ...
            u.push(
              '/post/'.concat(
                null === (e = w.data) || void 0 === e ? void 0 : e.id,
                '/edit'
              )
            )
          },
          ...
          l = (0, y.useSession)().data,
          u = (0, N.useRouter)(),
          f = v.S.useContext(),
          g = F(Number(u.query.id)),
          w = v.S.useQuery(g),
          C = v.S.useMutation(['post.like'], {
            onMutate: (function () {
              var e = O(
                r().mark(function e(n) {
                  var t
                  return r().wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (e.next = 2), f.cancelQuery(g)
                        case 2:
                          return (
                            (t = f.getQueryData(g)) &&
                              f.setQueryData(
                            ...
                            e.abrupt('return', { previousPost: t })
                          )
                        case 5:
                        case 'end':
                          return e.stop()
            ...
            onError: function (e, n, t) {
              ;(null === t || void 0 === t ? void 0 : t.previousPost) &&
                f.setQueryData(g, t.previousPost)
            },
          }),
          S = v.S.useMutation(['post.unlike'], {
            onMutate: (function () {
              var e = O(
                r().mark(function e(n) {
                  var t
                          ...
                          return (
                            (t = f.getQueryData(g)) &&
                              f.setQueryData(
                                g,
                                P({}, t, {
                                  likedBy: t.likedBy.filter(function (e) {
                                    return e.user.id !== l.user.id
                                  }),
                                })
                              ),
                            e.abrupt('return', { previousPost: t })
          ...
          R = V[1]
        if (w.data) {
          var H = 'ADMIN' === l.user.role,
            X = w.data.author.id === l.user.id
          return (0, i.jsxs)(i.Fragment, {
            children: [
              (0, i.jsx)(b.default, {
                children: (0, i.jsxs)('title', {
                  children: [w.data.title, ' - Beam'],
                }),
              }),
              (0, i.jsxs)('div', {
                ...
                children: [
                    ...
                    children: [
                      ...
                      (0, i.jsxs)('div', {
                        ...
                        children: [
                          (0, i.jsx)('h1', {
                            className:
                              'text-3xl font-semibold tracking-tighter md:text-4xl',
                            children: w.data.title,
                          }),
                          (X || H) &&
                            (0, i.jsxs)(i.Fragment, {
                              children: [
                                (0, i.jsx)('div', {
                                  ...
                                  children: (0, i.jsxs)(p.v2, {
                                    children: [
                                      (0, i.jsx)(p.j2, {
                                        as: h.h,
                                        variant: 'secondary',
                                        title: 'More',
                                        children: (0, i.jsx)(x.YA, {
                                          className: 'w-4 h-4',
                                        }),
                                      }),
                                      (0, i.jsx)(p.sd, {
                      ...
                      (0, i.jsx)('div', {
                        ...
                        children: (0, i.jsx)(a.l, {
                          ...
                          date: w.data.createdAt,
                        }),
                      }),
                      (0, i.jsx)(m.u, {
                        html: w.data.contentHtml,
                        className: 'mt-8',
                      }),
                      (0, i.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, i.jsxs)(d.Z, {
                            href: '/post/'.concat(w.data.id, '#comments'),
                            variant: 'secondary',
                            children: [
                              (0, i.jsx)(x.P$, {
                              ...
                              (0, i.jsx)('span', {
                                className: 'ml-1.5',
                                children: w.data._count.comments,
                              }),
                            ],
                          }),
                        ],
                  ...
                  (0, i.jsxs)('div', {
                    ...
                    children: [
                      w.data.comments.length > 0 &&
                        (0, i.jsx)('ul', {
                          className: 'space-y-12',
                          children: w.data.comments.map(function (e) {
                            return (0,
                            i.jsx)('li', { children: (0, i.jsx)(Q, { postId: w.data.id, comment: e }) }, e.id)
                          }),
                        }),
                      (0, i.jsxs)('div', {
        ...
        return w.isError
          ? (0, i.jsxs)('div', { children: ['Error: ', w.error.message] })
          : (0, i.jsxs)('div', {
              ...
              children: [
                ...
                (0, i.jsx)('div', {
                  ...
                  children: E(Array(3)).map(function (e, n) {
                    return (0,
                ...
                (0, i.jsxs)('div', {
                  ...
                  children: [
                    (0, i.jsx)('div', {
                      className:
                        'w-16 border rounded-full h-button border-secondary',
                    }),
                    (0, i.jsx)('div', {
                      className:
                        'w-16 border rounded-full h-button border-secondary',
      ...
      function Q(e) {
        var n = e.postId,
          ...
          u = d[0],
          f = d[1],
          j = t.author.id === s.user.id
        return c
          ? (0, i.jsxs)('div', {
              className: 'flex items-start gap-4',
              children: [
                (0, i.jsx)(o.q, { name: t.author.name, src: t.author.image }),
                (0, i.jsx)(q, {
                  postId: n,
                  comment: t,
                  onDone: function () {
          ...
          : (0, i.jsxs)('div', {
              children: [
                (0, i.jsxs)('div', {
                  className: 'flex items-center justify-between gap-4',
                  children: [
                    (0, i.jsx)(a.l, { author: t.author, date: t.createdAt }),
                    j &&
                      (0, i.jsxs)(p.v2, {
                        children: [
                          (0, i.jsx)(p.j2, {
                ...
                (0, i.jsx)('div', {
                  className: 'mt-4 pl-11 sm:pl-16',
                  children: (0, i.jsx)(m.u, { html: t.contentHtml }),
                }),
                (0, i.jsx)(M, {
                  postId: n,
                  commentId: t.id,
      ...
      function Z(e) {
        var n = e.postId,
          ...
          r = t[1],
          a = v.S.useContext(),
          o = v.S.useMutation('comment.add', {
            onSuccess: function () {
              return a.invalidateQueries(F(n))
            },
            onError: function (e) {
              C.ZP.error('Something went wrong: '.concat(e.message))
            },
          }),
          c = (0, w.cI)(),
          d = c.control,
      ...
      function q(e) {
        var n = e.postId,
          ...
          s = e.onDone,
          r = v.S.useContext(),
          a = v.S.useMutation('comment.edit', {
            onSuccess: function () {
              return r.invalidateQueries(F(n))
            },
            onError: function (e) {
              C.ZP.error('Something went wrong: '.concat(e.message))
            },
          }),
          o = (0, w.cI)({ defaultValues: { content: t.content } }),
          c = o.control,
          d = o.handleSubmit,
          u = function (e) {
            a.mutate(
              { id: t.id, data: { content: e.content } },
              {
                onSuccess: function () {
                  return s()
                },
      ...
      function M(e) {
        var n = e.postId,
          ...
          a = k.useRef(null),
          o = v.S.useContext(),
          c = v.S.useMutation('comment.delete', {
            onSuccess: function () {
              return o.invalidateQueries(F(n))
            },
            onError: function (e) {
              C.ZP.error('Something went wrong: '.concat(e.message))
            },
          })
        return (0, i.jsxs)(u.Vq, {
          isOpen: s,
          onClose: r,
          initialFocus: a,
          children: [
            (0, i.jsxs)(u.cZ, {
              children: [
                (0, i.jsx)(u.$N, { children: 'Delete comment' }),
                (0, i.jsx)(u.Be, {
                  className: 'mt-6',
                  children: 'Are you sure you want to delete this comment?',
                }),
                (0, i.jsx)(u.iK, { onClick: r }),
              ],
            }),
            (0, i.jsxs)(u.kX, {
              children: [
      ...
      function B(e) {
        ...
        return (0, i.jsxs)(u.Vq, {
          ...
          children: [
            (0, i.jsxs)(u.cZ, {
              children: [
                (0, i.jsx)(u.$N, { children: 'Delete post' }),
                (0, i.jsx)(u.Be, {
                  className: 'mt-6',
                  children: 'Are you sure you want to delete this post?',
                }),
                (0, i.jsx)(u.iK, { onClick: s }),
              ],
            }),
            (0, i.jsxs)(u.kX, {
              children: [
      ...
      function T(e) {
        ...
        return (0, i.jsxs)(u.Vq, {
          ...
          children: [
            (0, i.jsxs)(u.cZ, {
              children: [
                (0, i.jsx)(u.$N, { children: 'Hide post' }),
                (0, i.jsx)(u.Be, {
                  className: 'mt-6',
                  children: 'Are you sure you want to hide this post?',
                }),
                (0, i.jsx)(u.iK, { onClick: s }),
              ],
            }),
      ...
      function _(e) {
        ...
        return (0, i.jsxs)(u.Vq, {
          ...
          children: [
            (0, i.jsxs)(u.cZ, {
              children: [
                (0, i.jsx)(u.$N, { children: 'Unhide post' }),
                (0, i.jsx)(u.Be, {
                  className: 'mt-6',
                  children: 'Are you sure you want to unhide this post?',
                }),
                (0, i.jsx)(u.iK, { onClick: s }),
              ],
            }),
      ...
      ;(L.auth = !0),
        (L.getLayout = function (e) {
          return (0, i.jsx)(f.A, { children: e })
        }),
        (n.default = L)
    },
  },
  function (e) {
    e.O(0, [33, 364, 543, 944, 416, 135, 97, 774, 888, 179], function () {
      return (n = 174), e((e.s = n))
      var n
    })
    var n = e.O()
    _N_E = n
