...
/* harmony export */   "J": () => (/* binding */ buttonClasses),
...
/* harmony import */ var _lib_classnames__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(370);
...
function buttonClasses({ className , variant ='primary' , responsive , isLoading , disabled  }) {
    return (0,_lib_classnames__WEBPACK_IMPORTED_MODULE_3__/* .classNames */ .A)('inline-flex items-center justify-center font-semibold transition-colors rounded-full focus-ring', responsive ? 'px-3 h-8 text-xs sm:px-4 sm:text-sm sm:h-button' : 'px-4 text-sm h-button', variant === 'primary' && 'text-secondary-inverse bg-secondary-inverse hover:text-primary-inverse hover:bg-primary-inverse', variant === 'secondary' && 'border text-primary border-secondary bg-primary hover:bg-secondary', (disabled || isLoading) && 'opacity-50 cursor-default', className);
}
const Button = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_2__.forwardRef(({ className , variant ='primary' , responsive , type ='button' , isLoading =false , loadingChildren , disabled , children , ...rest }, forwardedRef)=>{
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", {
        ...
        children: [
            isLoading && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_icons__WEBPACK_IMPORTED_MODULE_1__/* .SpinnerIcon */ .L4, {
...
function Footer() {
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)("footer", {
        className: "flex flex-col items-center justify-between gap-2 text-sm md:gap-4 md:flex-row text-secondary",
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(icons/* HeartFilledIcon */.rg, {
                        className: "w-4 h-4"
                    }),
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("a", {
                ...
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(icons/* GithubLogo */.bY, {
                        className: "w-4 h-4"
                    }),
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("span", {
                        children: [
...
/* harmony export */   "h_": () => (/* binding */ HeartIcon),
/* harmony export */   "rg": () => (/* binding */ HeartFilledIcon),
...
/* harmony export */   "mY": () => (/* binding */ BoldIcon),
/* harmony export */   "h3": () => (/* binding */ ItalicIcon),
/* harmony export */   "DE": () => (/* binding */ ListIcon),
/* harmony export */   "xP": () => (/* binding */ LinkIcon),
/* harmony export */   "b0": () => (/* binding */ XIcon),
/* harmony export */   "tE": () => (/* binding */ EyeIcon),
/* harmony export */   "LA": () => (/* binding */ EyeClosedIcon),
/* harmony export */   "YA": () => (/* binding */ DotsIcon),
/* harmony export */   "Bu": () => (/* binding */ MarkdownIcon),
/* harmony export */   "TR": () => (/* binding */ Logo),
/* harmony export */   "bY": () => (/* binding */ GithubLogo),
/* harmony export */   "L4": () => (/* binding */ SpinnerIcon)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
